#!/usr/bin/env python3
#  ---------       configurations for boiler        ---------
# directory of boilerplate code src:
BOILERPLATESDIR='/Users/willyspinner/willysBin/boiler_project/boilerplates'
# command for cmd editor of choice.
EDITOR='vi'
# directory of boiler plate scripts
